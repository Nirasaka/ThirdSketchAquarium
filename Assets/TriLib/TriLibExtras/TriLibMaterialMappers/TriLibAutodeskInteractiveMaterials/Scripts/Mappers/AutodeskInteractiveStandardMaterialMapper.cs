...
namespace TriLibCore.Mappers
{
    ...
    public class AutodeskInteractiveStandardMaterialMapper : StandardMaterialMapper
    {
        ...
        {
            if (!PackageUtils.HasPackage("com.unity.shadergraph"))
            {
                Debug.LogWarning("The AutodeskInteractiveStandardMaterialMapper needs the com.unity.shadergraph package installed");
                return false;
            }
